...
- `Temperance Challenge Solutions.md` - evidence-backed solutions for HackMyVM HMVLabs Temperance levels 00-32, including bytes/text transforms, images, archives, HTTP, JWT, OCR, QR, XOR, and bounded brute force.
