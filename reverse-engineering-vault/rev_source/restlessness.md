>[!NOTE]
>The challange file is updated to be a little bit harder. The solution step is still the same though.
...
On the last line is an unreachable code that simply print the first part of the flag.
...
Fisrt of all,
it forcefully delete all configured profiles if even just JAMF is detected. (who cares)
