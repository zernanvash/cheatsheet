...
This is a compact role index for authorized labs and CTF-style boot2root work.
...
Use the path notes as the main workflow. Tool sheets are reference pages for command variants, payload reminders, and deeper examples.
