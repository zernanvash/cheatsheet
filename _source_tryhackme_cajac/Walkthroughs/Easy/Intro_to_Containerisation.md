...
Room link: [https://tryhackme.com/room/introtocontainerisation](https://tryhackme.com/room/introtocontainerisation)
...
![Docker Orchestration](Images/Docker_Orchestration.png)
...
These “images” can be exported, shared and uploaded to both public and private repositories such as [DockerHub](https://hub.docker.com/) and GitHub. The “image” can be run by anything that supports the Docker engine, as long as the syntax is valid.
...
![Process Example 1](Images/Process_Example_1.png)
...
![Process Example 2](Images/Process_Example_2.png)
...
1. Application
2. Container OS (Minimal)
3. Container Engine
4. Physical Machine OS
5. Physical Machine
